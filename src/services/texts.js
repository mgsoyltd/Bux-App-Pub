const texts = {
  en: {
    ...
    image_cancelled: "No image selected",
    book_saved: "Book saved successfully.",
    book_deleted: "Book deleted successfully.",
    book_already_deleted: "This book has already been deleted.",
    access_denied: "Access denied.",
    too_many_attempts: "Account locked - Too many invalid authentication attempts.",
    ...
    image_cancelled: "Kuvaa ei valittu",
    ...
    too_many_attempts: "Tili lukittu - liian monta virheellistä sisäänkirjautumista",
    bad_request: "Virheellinen pyyntö.",
    internal_error: "Palvelimen sisäinen virhe.",
